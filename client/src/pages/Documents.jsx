...
export default function Documents() {
  ...
  return (
    <div className="w-full max-w-[800px] mx-auto px-5 min-h-[calc(100vh-72px)] py-8">
      ...
      {/* Requirement Tracker */}
      <div className="bg-white dark:bg-gray-900 border-y border-r border-l-4 border-l-black border-y-gray-200 border-r-gray-200 rounded-r-xl shadow-sm animate-fade-in p-5 mb-6">
        <h3 className="font-[700] mb-3 flex items-center gap-2 text-gray-900 dark:text-white">
      ...
      <div className="grid grid-cols-1 gap-6">
        ...
        {/* Upload Form */}
        <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl shadow-sm animate-fade-in">
          <div className="px-6 py-5 border-b border-gray-200 dark:border-gray-700">
            <h3 className="font-[700] flex items-center gap-2 text-gray-900 dark:text-white">
          ...
          <form onSubmit={handleUpload} className="p-6">
            ...
            <div className="flex flex-col gap-1.5 mb-4">
              <label className="text-[0.85rem] font-medium text-gray-500 dark:text-gray-400 tracking-[0.02em]">Document Type</label>
              <select 
                className="w-full px-4 py-3 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg text-gray-900 dark:text-white text-[0.95rem] transition-all outline-none focus:border-black focus:ring-[3px] focus:ring-black/5 appearance-none cursor-pointer" 
            ...
            <div className="flex flex-col gap-1.5 mb-6">
              <label className="text-[0.85rem] font-medium text-gray-500 dark:text-gray-400 tracking-[0.02em]">Upload File</label>
              <input 
                id="docUpload"
                type="file" 
                className="w-full px-3.5 py-2.5 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg text-gray-900 dark:text-white text-[0.95rem] transition-all outline-none focus:border-black focus:ring-[3px] focus:ring-black/5 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-gray-50 dark:bg-gray-800 file:text-gray-700 dark:text-gray-300 hover:file:bg-gray-100 dark:bg-gray-800" 
                onChange={(e) => setForm({ ...form, document: e.target.files[0] })}
                accept="image/jpeg,image/png,image/webp,application/pdf"
                required 
              />
              <div className="text-[0.75rem] text-gray-500 dark:text-gray-400 mt-1.5">
        ...
        {/* Document List */}
        <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl shadow-sm animate-fade-in stagger-1">
          <div className="px-6 py-5 border-b border-gray-200 dark:border-gray-700">
            <h3 className="font-[700] flex items-center gap-2 text-gray-900 dark:text-white">
          ...
          <div className="p-6">
            {documents.length === 0 ? (
              ...
              <div className="flex flex-col gap-4">
                {documents.map((doc) => (
                  <div key={doc.id} className="flex items-center justify-between p-4 border border-gray-200 dark:border-gray-700 rounded-lg bg-gray-50 dark:bg-gray-800 gap-4 flex-wrap">
                    <div className="flex items-center gap-4">
                      <div className="w-11 h-11 rounded-[10px] bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 flex items-center justify-center">
                        <FileText size={20} className="text-gray-900 dark:text-white" />
                      </div>
                      <div>
                        <div className="font-[600] text-[0.95rem] mb-0.5 text-gray-900 dark:text-white">{DOC_TYPES[doc.type] || doc.type}</div>

...
const vehicleTypes = [
  { type: 'Cars', emoji: '🚗', count: '2,500+', gradient: 'bg-gray-50 dark:bg-gray-800', textCol: 'text-gray-900 dark:text-white' },
  { type: 'Bikes', emoji: '🏍️', count: '1,800+', gradient: 'bg-gray-50 dark:bg-gray-800', textCol: 'text-gray-900 dark:text-white' },
  { type: 'Scooters', emoji: '🛵', count: '900+', gradient: 'bg-gray-50 dark:bg-gray-800', textCol: 'text-gray-900 dark:text-white' },
];
    ...
    <div>
        ...
        <div className="w-full max-w-[1280px] mx-auto px-5 relative z-10">
          <div className="max-w-[720px] mx-auto text-center">
            <div className="animate-fade-in mb-5">
              <span className="inline-flex items-center gap-1.5 bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 px-4 py-1.5 rounded-full text-xs font-bold uppercase tracking-wider">
            ...
            <p className="animate-fade-in stagger-2 text-[1.15rem] text-gray-500 dark:text-gray-400 max-w-[540px] mx-auto mb-10 leading-[1.7]">
            ...
            <div className="animate-fade-in stagger-3 flex gap-4 justify-center flex-wrap">
              <Link to="/vehicles" className="inline-flex items-center justify-center gap-2 px-9 py-4 text-[1.05rem] font-semibold rounded-lg text-white bg-black dark:bg-white dark:text-black hover:bg-gray-800 shadow-sm transition-all hover:-translate-y-0.5">
                Browse Vehicles <ArrowRight size={18} />
              </Link>
              <Link to="/register" className="inline-flex items-center justify-center gap-2 px-9 py-4 text-[1.05rem] font-semibold rounded-lg text-gray-900 dark:text-white bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800 dark:bg-gray-800 hover:border-gray-500 shadow-sm transition-all hover:-translate-y-px">
                List Your Vehicle
              </Link>
            </div>
          </div>
          ...
          {/* Stats bar */}
          <div className="animate-slide-up stagger-4 max-w-[800px] mx-auto mt-[60px] grid grid-cols-2 md:grid-cols-4 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl shadow-sm overflow-hidden divide-y md:divide-y-0 md:divide-x divide-gray-100">
            {stats.map((s, i) => (
              <div key={i} className="p-6 text-center">
                <div className="text-[1.8rem] font-[800] text-gray-700 dark:text-gray-300">{s.value}</div>
                <div className="text-[0.8rem] text-gray-500 dark:text-gray-400 mt-1">{s.label}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="w-full max-w-[1280px] mx-auto px-5 py-[60px]">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-500 dark:text-gray-400 max-w-[480px] mx-auto">Choose from our diverse fleet of verified vehicles</p>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          {vehicleTypes.map((v, i) => (
            <Link to={`/vehicles?type=${v.type.toLowerCase().slice(0, -1)}`} key={i} className="animate-fade-in bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl overflow-hidden hover:-translate-y-1 hover:shadow-lg hover:border-gray-400 transition-all duration-300 p-8 text-center cursor-pointer" style={{ animationDelay: `${i * 0.1}s` }}>
              ...
              <div className="mt-4 text-gray-900 dark:text-white text-[0.9rem] font-[600] flex items-center justify-center gap-1.5">
      ...
      {/* FEATURES */}
      <section className="py-[80px] bg-gray-50 dark:bg-gray-800">
        <div className="w-full max-w-[1280px] mx-auto px-5">
          <div className="text-center mb-14">
            <h2 className="text-[2.2rem] font-[800] tracking-[-0.02em] mb-3">
              Why Choose <span className="text-black font-black">Rentora</span>?
            </h2>
            <p className="text-gray-500 dark:text-gray-400 max-w-[480px] mx-auto">Built for trust, speed, and convenience</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {features.map((f, i) => (
              <div key={i} className="animate-fade-in bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl shadow-sm p-9" style={{ animationDelay: `${i * 0.15}s` }}>
                ...
                <p className="text-gray-500 dark:text-gray-400 text-[0.9rem] leading-[1.7]">{f.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="w-full max-w-[1280px] mx-auto px-5 py-[80px]">
        <div className="text-center mb-14">
          ...
          <p className="text-gray-500 dark:text-gray-400 max-w-[480px] mx-auto">Get on the road in three simple steps</p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {steps.map((s, i) => (
            <div key={i} className="animate-fade-in relative px-2" style={{ animationDelay: `${i * 0.15}s` }}>
              ...
              <p className="text-gray-500 dark:text-gray-400 text-[0.9rem] leading-[1.7]">{s.desc}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="w-full max-w-[1280px] mx-auto px-5 pt-[40px] pb-[80px]">
        <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl shadow-sm px-10 py-16 text-center relative overflow-hidden">
          ...
          <p className="text-gray-500 dark:text-gray-400 mb-8 max-w-[420px] mx-auto relative">
          ...
          <div className="flex gap-4 justify-center flex-wrap relative">
            ...
            <Link to="/vehicles" className="inline-flex items-center justify-center gap-2 px-9 py-4 text-[1.05rem] font-semibold rounded-lg text-gray-900 dark:text-white bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800 dark:bg-gray-800 hover:border-gray-500 shadow-sm transition-all hover:-translate-y-px">
